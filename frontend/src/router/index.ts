        ...
        children: [
          {
            ...
            meta: { title: 'Media' },
            component: (): Component =>
              import('@/views/dashboard/workplace/media.vue'),
          },
        ],
      },
      {
        ...
        component: (): Component =>
          import('@/views/dashboard/workplace/my-application.vue'),
      },
      {
        ...
        component: (): Component =>
          import('@/views/dashboard/workplace/pending-application.vue'),
      },
      {
        path: '/create-media',
        name: 'Create Media',
        ...
        component: (): Component =>
          import('@/views/dashboard/workplace/create-media.vue'),
      },
      // // dashboard
      // {
      //   name: 'Dashboard',
...
export const staticRoutes: MenuDataItem[] = [
  ...
  },
  {
    path: '/viewer/:id',
    name: 'viewer',
    meta: { title: 'License Viewer' },
    component: (): Component => import('@/views/dashboard/workplace/viewer.vue'),
  },
  {
    path: '/user',
    name: 'user',
